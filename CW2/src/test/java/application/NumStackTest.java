 ...
 * implemented into Stack class. In other world the the meaning is to implement numStack class as it is
 * a Stack class wiith the only capability to get only float number entry.
 * 
 * @author papap
 *
 */
class NumStackTest {
  ...
  // will increase.
  // Next, I have created  pop method. To do so i had to add also all the exception(confirming the also 
  //pop method in numStack retreave the functionality of the pop method in Stack class.
  @Test 
  void Poptest() throws EmptyStack {
