...
class OpStackTest {
  ...
  void Constructortest() {
    assertNotNull("OpStack shuld be constructed", opStack);
  ...
  //test 3 the index of the stack is releted to the last push( this est can confirm prt of the size test method as well).  
  @Test
